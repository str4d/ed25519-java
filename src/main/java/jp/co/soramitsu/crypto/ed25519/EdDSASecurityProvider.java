...
public class EdDSASecurityProvider extends Provider {
    ...
    protected void setup() {
        ...
        put("KeyPairGenerator." + EdDSAKey.KEY_ALGORITHM, "jp.co.soramitsu.crypto.ed25519.KeyPairGenerator");
        put("Signature." + EdDSAEngine.SIGNATURE_ALGORITHM, "jp.co.soramitsu.crypto.ed25519.EdDSAEngine");
